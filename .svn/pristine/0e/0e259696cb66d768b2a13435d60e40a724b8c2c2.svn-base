...
namespace ThirdAPI
{
    public class GeetestLib_V2
    {
        ...
        public GeetestLib_V2(String publicKey, String privateKey)
        {
 ...
 //               this.captchaID, challenge) + "}";
        ...
        private String registerChallenge()
        {
            ...
            {
                url = string.Format("{0}{1}?gt={2}&client_type={3}&ip_address={4}", GeetestLib_V2.apiUrl, GeetestLib_V2.registerUrl, this.captchaID, this.client_type, this.ip_address);
            }
            else
            {
                url = string.Format("{0}{1}?gt={2}&user_id={3}&client_type={4}&ip_address={5}", GeetestLib_V2.apiUrl, GeetestLib_V2.registerUrl, this.captchaID, this.userID, this.client_type, this.ip_address);
            }
        ...
        {
            String url = string.Format("{0}{1}", GeetestLib_V2.apiUrl, GeetestLib_V2.validateUrl);
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(url);
            request.Method = "POST";

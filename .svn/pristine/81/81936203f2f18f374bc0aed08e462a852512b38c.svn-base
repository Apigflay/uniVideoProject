...
namespace WebAPI
{
    ...
    {
        #region 构造函数
        public Push_Single_Device(string secret_key, BaiduModel mod)
        {
        ...
        public Push_Single_Device(string httpMehtod, string secret_key, BaiduModel mod)
        {
        ...
        public override string PushMessage()
        {
            ...
            return strResult;
             * */
            return Baidu_Helper.SendBaidu(this.httpMehtod, this.url, this.secret_key, this.mod);
        }
        #endregion

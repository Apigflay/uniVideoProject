<template>
	<view class="main">
		...
		<view v-if="showsever" class="showsever">
			...
			<view class="p">line：mycat1314</view>
		</view>
		<!-- 客服弹出层 -->
	</view> 
</template>
	...
	export default {
		...
		methods:{
			...
			getLoginMsg:function(){ // 登录信息
				this.Sex=this.$store.getters['AllallLoginInfo'].preference
				var that = this;
				uni.getStorage({
			...
			goExit:function(){
				...
				// window.location.href='https://www.mycat1314.com'
				window.location.href='https://www.mycat1314.com/#/'

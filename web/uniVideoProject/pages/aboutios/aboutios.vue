<template>
	<view class="main">
		...
		<view class="center">
			<image src="../../static/imgs/logoApp.png" class="img"></image>
			<!-- <view class="text1">App</view> -->
			<view class="text1">v1.0.0(866b67a)</view>
			<view class="text1">@cat 版權所有</view>
			<!-- <view  class="text2">For more information visit</view> -->
			<!-- <view class="yellow">www.mycat1314.im</view> -->
			<!-- <view class="text3" >聯繫客服</view> -->
			<!-- <view class="yellow">catr@mycat1314.im</view> -->

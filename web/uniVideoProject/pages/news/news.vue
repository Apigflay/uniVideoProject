<template>
	<scroll-view scroll-y="true" @scrolltolower="getNewmsg" class="main">
		<view class="top">
			...
			<view class="title">
				<text class="p">{{this.Language.language[this.tabbarLoginLanguage].language82}}</text>
			</view>
			<!-- @click="goPay()" -->
						...
						<view class="right">
							<view class="newmsg">
								<view class="show">
									...
									<text class="p1" v-if="tabbarLoginLanguage==0||tabbarLoginLanguage==1">新帖子</text>
									<text class="p1" v-if="tabbarLoginLanguage==2">New post</text>
									<text class="p1" v-if="tabbarLoginLanguage==3">สติ๊กเกอร์ใหม่</text>
								</view>
							</view>
							<text v-if="item.show_hours" class="p2">{{sy_remaining[tabbarLoginLanguage]}}{{item.hours}}{{sy_hour[tabbarLoginLanguage]}}</text>
							<text v-if="item.show_minutes" class="p2">{{sy_remaining[tabbarLoginLanguage]}}{{item.minutes}}{{sy_min[tabbarLoginLanguage]}}</text>
							<text v-if="item.show_seconds" class="p2">{{sy_remaining[tabbarLoginLanguage]}}{{item.seconds}}{{sy_sec[tabbarLoginLanguage]}}</text>
						</view>
					</view>
				</view>
			</view>

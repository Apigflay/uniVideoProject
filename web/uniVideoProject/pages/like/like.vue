...
<script>
	import {encrypt,decrypt,system,systemId,base64ToArrayBuffer,sendData,sendD,work,sendD07,sendD11,navigateTo,sendDSocket} from "../../lib/js/GlobalFunction.js"
	export default {
		data() {
			return {
		...
		methods:{
			...
			getChoice:function(){
				...
				console.log(array)
				this.$store.commit("set_allSexStatus",Number(this.Sex))
				uni.onSocketOpen(function (res) {
				  console.log('WebSocket连接已打开！');
				  uni.sendSocketMessage({//11011 设置喜好（客户端->服务端）
				    data: sendDSocket(array,11011),
				    success(res) {
				...
				// 				storage_login_str.preference=that.Sex;

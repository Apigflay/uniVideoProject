	...
	<view class="main">
		...
		<view class="head">
			...
			<view class="box" :style="show==false?'background:#808080':''" @click="follow()">
				<text v-if="show" class="p">{{this.Language.language[this.tabbarLoginLanguage].language71}}</text>
				<text v-else class="p1">{{this.Language.language[this.tabbarLoginLanguage].language62}}</text>
			</view>
		</view>
		<!-- 头像 关注 -->
		<!-- 用户名 国籍 -->

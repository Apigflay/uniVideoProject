...
<script>
	...
	export default {
		...
		onLoad:function(obj){
			...
			// console.log(decrypt("A3d1HEgoLQCNkz5+Vo5pl1LwNnY2uWpy0Nn5fCZFpB//cWvugSgzZtUZV6tr7A6SCPTYmbsH2Iw7pz8OGu3++w=="))
			// console.log(decrypt(decodeURIComponent("GHhqxrdPkZWd6LQLLjjLfFLwNnY2uWpy0Nn5fCZFpB+%2Fx+FhFPffte69SI4+4IJB%2Fs0Lp7F2MIe5Iq9K5JbMztA781+dcwtYJyH6qjDJz5Q%3D")))

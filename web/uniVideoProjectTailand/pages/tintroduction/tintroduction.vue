<template>
	<view class="content">
		...
		<image class="bgImg" src="../../static/imgs/TintroductionE.jpg" mode="" v-if="loginLanguage==0||loginLanguage==1||loginLanguage==2"></image>
		<image class="bgImg" src="../../static/imgs/TintroductionT.jpg" mode="" v-if="loginLanguage==3"></image>
	</view>
</template>

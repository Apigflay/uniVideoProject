...
<script>
	...
	export default {
		...
		methods:{
			...
			goGift:function(){
				var obj = encodeURIComponent(encrypt(JSON.stringify({
					useridx: this.Anchordata.Anchor.UserIdx,
					nickname: this.Anchordata.Anchor.MyName,
					headpic: this.Anchordata.Anchor.SmallPic,
					online: this.Anchordata.Anchor.Online,
					pageId: 7,
					pagebackId : this.pageId,
				})))
							 ...
							 var fileReader = new FileReader();
							     fileReader.onload = function (progressEvent) {
									...
									if(HeadRecv[1]==10002){
										...
										// ---先重连---
										var obj = encodeURIComponent(encrypt(JSON.stringify({
											useridx: that.Anchordata.Anchor.UserIdx,
											nickname: that.Anchordata.Anchor.MyName,
											headpic: that.Anchordata.Anchor.SmallPic,
											online: that.Anchordata.Anchor.Online,
											pageId: 7,
											pagebackId : that.pageId,
										})))
										navigateTo('/pages/chatpop/chatpop',obj);

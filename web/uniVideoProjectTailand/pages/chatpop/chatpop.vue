	...
	export default {
		data() {
			return {
				...
				chatNewMsgData:[],//最新聊天信息
				
				fy_span_p1_0:['以','以','Spend','ใช้'],//Spend  Use
				fy_span_p1_1:['传送信息','傳送信息',' coin sending message','ส่งต่อข้อความ'],//coin sending message   to send message
			};
		},
		onLoad(obj) {
